 ...
 * 
 */
function createSelectionForm(request)
{
	...
	try
	{
		...
		campaigncode = request.getParameter('custparam_campaigncode');
		
		//Create selection form
		if(campaigncode)
		{
			selectionForm = nlapiCreateForm('Catalogue Item Selector '+campaigncode,true);
		}
		else
		{
