 ...
 * 
 * Version: 	1.0.0 - 01/05/2013 - Initial release
 * 
 * Author: 		FHL
 * 
 * Purpose: 	Remove all transactions records from production
 * 
 * Script: 		customscript_removealltransactions
 * Deploy: 		customdeploy_removealltransactions
 * 
 ***********************************************************************************************************************/
...
{
	while(deleteallrecords('customer','altname') == true)
	{
