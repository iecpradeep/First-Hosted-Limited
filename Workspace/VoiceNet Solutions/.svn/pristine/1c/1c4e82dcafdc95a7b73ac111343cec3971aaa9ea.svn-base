/*************************************************************************************
 * Name:		voicenetTurnOnCallback.js 
 ...
 * Author:		FHL
 * 
 * Purpose:		Turns on the Voicenet service for call backs to our URL
 * 
 * Script: 		customscript_voicenetturnoncallback
 * Deploy: 		customdeploy_voicenetturnoncallback
 * 
 * Library: 	library.js
 *************************************************************************************/
...
function voicenetTurnOnCallback(request, response)
{
	...
	// nlapiLogExecution('DEBUG', 'voicenetTurnOnCallback');
	try
	{
