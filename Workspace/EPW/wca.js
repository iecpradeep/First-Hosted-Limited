 ...
 * Version:		1.4.0
 * Date:		24 June 2011 - 15th August 2011
...
function saveInvItem(type)
{
	...
	var RoundingMultiple = 0.05;		//Round to the nearest 5 pence.
	var TaxMultiple = 1.2;				//This will need to be changed when VAT changes again.
	var TWWLMultiple = 1.1;				//The Wine Wedding List Multiple
	try 
	{
	...
	var TWWLPrice =  mRound(RoundingMultiple,(SalesPrice * TWWLMultiple * TaxMultiple))/TaxMultiple;
	invRecord.setFieldValue('custitem_twwlpriceincvat', TWWLPrice * TaxMultiple);
