 ...
 * Version:			1.7.000
 * Date:					November 2011 - 12th March 2012
 ...
 * @param {Object} column
 */
function YTDByTypeAllTeams(portlet, column)
{   
...
var numOfEmployees = searchEmployeeResult.length;
	...
	//portlet.setTitle(TheTeam + ' - Year to date result by Sales Person.');



	portlet.setTitle('Year to Date Result by Type of Sale - All Teams');// Teams Included: ' + TheTeam.length + " - Types Len: " + Types.length);
