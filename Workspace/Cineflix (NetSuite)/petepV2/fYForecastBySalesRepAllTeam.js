 ...
 * Purpose:			Full Year Forecast by Sales Rep, All Teams
 * Script Type:		Javascript
 * Version:			1.7.000
 * Date:					November 2011 - 8th May 2012
 ...
 * @param {Object} column
 */
function fYForecastTeamAllTeams(portlet, column)
{   
	...
	var numOfEmployees = searchEmployeeResult.length;
			...
			portlet.setTitle('Year to date result by Sales Person - All Teams.');
       ...
       content+= "<tr><td>&nbsp;</td><td><font size='2.4'><b>Column Totals:</b></font></td>";
		 ...
		 content += "%</b></u></font></td>";
    	 content+=    "<td align='right' title='Total deals required to reach the " + thisyear() + " target is $" + SumCADTotal.formatMoney(0,".",",") + "'><font size='2.4'><u><b>" + isNegative(SumCADTotal) + "</b></u></font></td></tr>";
