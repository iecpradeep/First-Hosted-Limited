 ...
 * 					line 512 and commented out SumLikelyTotal 
 * 					line 378. - A.D.M
 ...
 * @param {Object} column
 */
function H1forecastTypeOfSaleTeamOne(portlet, column)
{   
...
//	var EmpFYTotal = 0;
	...
	content+= "<td align='right' title='" + thisyear() + " H1 Target'><font size='2.4'>&nbsp<u><b>H1 "+thisyear()+" Target</b></u></font></td>";
...
//			Altered Verbal Weighting - AM
			...
			content+= "<td align='right' BGCOLOR='"+row_change(TheType) +"' title='" + thisyear() + " H1 Target for " + TypeName + " is $" 
			...
			content+= "<td align='right' BGCOLOR='"+row_change(TheType) +"' title='% Target Achieved for H1 " + thisyear() + " for " + TypeName + " is " 
					+ TypeFYTotal + "%'><font size='2.4'>" + TypeFYTotal + "%</font></td>";


			TypeCADTotal += parseInt(TypeTargetTotal - TypeLikelyTotal);

			content+= "<td align='right' BGCOLOR='"+row_change(TheType) +"' title='Deals Required to reach target for H1 " + TypeName + " is " 
	...
	try
	{
		...
		content+= "<td align='right' BGCOLOR='"+row_change(Types.length) +"' title='Likely Outcome for H1 " + thisyear() + " is $" + SumLikelyTotal.formatMoney(0, '.', ',') + "'><font size='2.4'><u><b>$" + SumLikelyTotal.formatMoney(0, '.', ',') + "</b></u></font></td>"; 
		content+= "<td align='right' BGCOLOR='"+row_change(Types.length) +"' title='" + thisyear() + " H1 Target is $" + SumTargetTotal.formatMoney(0, '.', ',')  + "'><font size='2.4'><u><b>$" + SumTargetTotal.formatMoney(0, '.', ',')  + "</b></u></font></td>";
		...
		content+= "<td align='right' BGCOLOR='"+row_change(Types.length) +"' title='% Target Achieved for H1 " + thisyear() + " is " + SumFYTotal + "%'><font size='2.4'><u><b>" + SumFYTotal + "%</b></u></font></td>";
