/*******************************************************
 * Name: 		YTDForecastByTypePerUser.js - Cineflix Custom Portlet script
 * Script Type:	Client
 *
 ...
 * 
 * Author:		FHL
 * Purpose:		YTD Forecast by Type Per User - To display the forecasts
...
/****************************
 * Year to Date Forecast by Type of Sale - User (Mine!)
 * 
 * @param {Object} portlet
 * @param {Object} column
 */
function YTDforecastTypeOfSaleUser(portlet, column)
{   
