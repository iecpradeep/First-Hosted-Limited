 ...
 * 					line 504. - A.D.M	
 * 
 * Date:			November 2011 - 30th May 2012
 ...
 * @param {Object} column
 */
function ytdForecastTeam1(portlet, column)
{   
...
//	Employee search
	...
	for(var emp = 0; emp < numOfEmployees; emp++)
	{
		...
		try
		{
			...
			if( Initiated != 0)
			{
				content += "<td align='right' BGCOLOR='" + row_change(emp) + "' title='Initiated Total for " + SalesRepName + " is $" + parseInt(EmpInitiatedTotal * Initiated) + "'><font size='2.4'>$" + parseInt(EmpInitiatedTotal * Initiated).formatMoney(0, '.', ',') + "</font></td>";
			}
			if( Pending != 0)
			{	
				content += "<td align='right' BGCOLOR='" + row_change(emp) + "' title='Pending Total for " + SalesRepName + " is $" + parseInt(EmpPendingTotal * Pending) + "'><font size='2.4'>$" + parseInt(EmpPendingTotal * Pending).formatMoney(0, '.', ',') + "</font></td>";
			}
			
//			Altered Verbal Wieghting - AM
	...
	try
	{
		...
		if( Pending != 0)
		{
			content+= "<td align='right' BGCOLOR='"+row_change(numOfEmployees) +"' title='Pending Total is $" + SumPendingTotal.formatMoney(0, '.', ',') 
		...
		content+= "<td align='right' BGCOLOR='"+row_change(numOfEmployees) +"' title='Likely Outcome for " + thisyear() + " is $" 
		...
		content+= "<td align='right' BGCOLOR='"+row_change(emp) +"' title='% Target Achieved for " + thisyear() + " is " + SumFYTotal + "%'><font size='2.4'><u><b>" 
