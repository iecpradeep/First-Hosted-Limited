 ...
 * @param {Object} column
 */
function H1SalesbySalesRepAllTeams(portlet, column)
{   
...
{
	   portlet.setHtml( "<p>There are no Sales Reps in this Team <img src='http://media.bigoo.ws/content/smile/sad/sad_60.gif' title='No Sales Reps in this team :('/></p>" );
       return true;
}
...
var numOfEmployees = searchEmployeeResult.length;
			...
			portlet.setTitle('H1 Result by Sales Person - All Teams.');
...
//    	   "<td align='right' title='Q4 Actual'><font size='2.4'><u><b>Q4 Actual</b></u></font></td>"+
    	   "<td align='right' title='Total Year to Date'><font size='2.4'><u><b>H1 Total</b></u></font></td>"+
...
//					content+=   "<td align='right' BGCOLOR='"+row_change(emp) +"' title='Q4 Actual  for " + SalesRepName + " is $" + EmpQ4Total + "'><font size='2.4'>$" + parseInt(EmpQ4Total).formatMoney(0,".",",")  +  "</font></td>";
					content+=   "<td align='right' BGCOLOR='"+row_change(emp) +"' title='H1 Total for " + SalesRepName + " is $" + EmpFYTotal + "'><font size='2.4'>$" + parseInt(EmpFYTotal).formatMoney(0,".",",") +  "</font></td>";
