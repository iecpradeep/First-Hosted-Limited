...
/****************************
 * H1 Forecast by Team - All
 * 
 * @param {Object} portlet
 * @param {Object} column
 */
function H1ForecastTeamAll(portlet, column)
{   
...
//	Employee search
	...
	for(var emp = 0; emp < numOfEmployees; emp++)
	{
		...
		try
		{
			...
			content += "<td align='right' BGCOLOR='" + row_change(emp) + "' title='Verbally Agreed Total for " + SalesRepName + " is $" + parseInt(EmpVerbalTotal * Verbal) + "'><font size='2.4'>$" + parseInt(EmpVerbalTotal * Verbal).formatMoney(0, '.', ',') + "</font></td>";
			content += "<td align='right' BGCOLOR='" + row_change(emp) + "' title='Deal Memo Total for " + SalesRepName + " is $" + parseInt(EmpDealMemoTotal * DealMemo) + "'><font size='2.4'>$" + parseInt(EmpDealMemoTotal * DealMemo).formatMoney(0, '.', ',') + "</font></td>";
			content += "<td align='right' BGCOLOR='" + row_change(emp) + "' title='In Negotiation Total for " + SalesRepName + " is $" + parseInt(EmpInNegTotal * InNegotiation) + "'><font size='2.4'>$" + parseInt(EmpInNegTotal * InNegotiation).formatMoney(0, '.', ',') + "</font></td>";
			content += "<td align='right' BGCOLOR='" + row_change(emp) + "' title='Actual Total for " + SalesRepName + " is $" + EmpSignedTotal + "'><font size='2.4'>$" + EmpSignedTotal.formatMoney(0, '.', ',') + "</font></td>";
			...
			content += "<td align='right' BGCOLOR='" + row_change(emp) + "' title='% Target Achieved for H1 " + thisyear() + " for " + SalesRepName + " is " + EmpFYTotal 
...
//		Altered Verbal Weighting
		...
		content+= "<td align='right' BGCOLOR='"+row_change(emp) +"' title='Deals Required to reach H1 target is $" + SumCADTotal.formatMoney(0, '.', ',') 
