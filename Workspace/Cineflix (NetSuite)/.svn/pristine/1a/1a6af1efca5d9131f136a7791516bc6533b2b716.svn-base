 ...
 * 					line 559 and commented out SumLikelyTotal 
 * 					line 356. - A.D.M	
 * 					2.0.0 - 30th October 2012 PAL
 ...
 * @param {Object} column
 */
function H1forecastTypeOfSaleAllTeams(portlet, column)
{   
...
//		content+= "<td align='right' BGCOLOR='"+row_change(Types.length) +"' title='Verbally Agreed Total is $" + SumVerbalTotal.formatMoney(0, '.', ',')  
...
//		Altered Verbal Weighting - AM
		...
		content+= "<td align='right' BGCOLOR='"+row_change(Types.length) +"' title='" + thisyear() + " H1 Target is $" + SumTargetTotal.formatMoney(0, '.', ',')  
