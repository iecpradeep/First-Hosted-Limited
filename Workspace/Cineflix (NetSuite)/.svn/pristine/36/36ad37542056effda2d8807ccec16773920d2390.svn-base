 ...
 * Version:			1.7.000
 * Date:					November 2011 - 9th March 2012
 ...
 * @param {Object} column
 */
function ytdTeam1(portlet, column)
{   
       ...
       content+= "<tr><td>&nbsp;</td><td title='Sales Rep'><font size='2.4'><u><b>Sales Rep</b></u></font></td>"+
		...
		for(var emp = 0; emp < numOfEmployees; emp++)
		{
			 ...
			 //  filters[2] = new nlobjSearchFilter( 'salesrep', 'customer', 'anyOf', -5, null );
			   ...
			   nlapiLogExecution('DEBUG', 'getNSFiscalStartDate() and getNSFiscalEndDate()', getNSFiscalStartDate() + "....." + getNSFiscalEndDate());
