 ...
 * 					line 593 and commented out SumLikelyTotal 
 * 					line 378. - A.D.M
 ...
 * @param {Object} column
 */
function H1forecastTypeOfSaleTeamTwo(portlet, column)
{   
...
// 		Altered Verbal Weighting - AM
		...
		content+= "<td align='right' BGCOLOR='"+row_change(Types.length) +"' title='Likely Outcome for H1 " + thisyear() + " is $" 
				+ SumLikelyTotal.formatMoney(0, '.', ',') + "'><font size='2.4'><u><b>$" + SumLikelyTotal.formatMoney(0, '.', ',') + "</b></u></font></td>"; 
		content+= "<td align='right' BGCOLOR='"+row_change(Types.length) +"' title='" + thisyear() + " H1 Target is $" 
				+ SumTargetTotal.formatMoney(0, '.', ',')  + "'><font size='2.4'><u><b>$" + SumTargetTotal.formatMoney(0, '.', ',')  + "</b></u></font></td>";
