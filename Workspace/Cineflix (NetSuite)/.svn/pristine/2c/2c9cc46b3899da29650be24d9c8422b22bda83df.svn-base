/*******************************************************
 * Name: 		H1ForecastBySalesPerUser.js - Cineflix Custom Portlet script
 * Script Type:	Portlet
 *
 * Version:		1.0.0 – 3/8/2012 – 1st release - PAL
 ...
 * Author:		FHL
 * Purpose:		H1 Forecast by Sales for Current User - To display the forecasts
 * 				for the H1 period for this User only.
 *          
 *******************************************************/
...
/****************************
 * H1 Forecast by Sales Person - User
 * 
 * @param {Object} portlet
 * @param {Object} column
 */
function H1ForecastBySalesUser(portlet, column)
{   
