 ...
 * 
 * Notes		[TODO] Needs to be refactored.
 * 
 * 
 * [TODO]   curly braces - the standard is to have them on separate lines
 * [TODO] 	getXMLforDeviceRequest - this routine is too big - please refactor e.g. stockbintransfer should be in it's own function
 * [TODO]  	declaration of variables should be at the top of a function rather than in the middle of code
 * [TODO] 	constants such as savedSearch = "customsearch_restquery_salesorders"; should be created in an initialise function i.e. putting them all together 
 * [TODO] 	function comment blocks need to be populated - i.e. arguements and return values and purpose need to be described
 * [TODO] 	When the release version of this code is ready - please remove all debug code.
 * [TODO] 	Use of the library - the generic error handler should be used for error trapping and to encourage code re-use
 * [TODO] 	Use of the library - utility type functions should be placed in the library
 * [TODO] 	Try catch on all code
 * [TODO] 	No compound statements i.e. one line of code does 1 things - helps debugging and readability - i.e. 	return createTaggedXML(currentDeviceRequest + "results", getXMLResultsStatus() + theXML);
 *
 * 
 * **************************************************************************/
...
function restMessage(datain)
{
    ...
    */
    ...
    // return the XML to the calling device / appplication.
	// ************************************************
	try {
