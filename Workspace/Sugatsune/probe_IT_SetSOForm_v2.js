...
v2 - Added verification of customer filed being filled for validation
...
if ((name == 'entity') && (updateform == 'F'))
	...
	if (isNotBlank(customer))
		...
		{
		alert('Please make sure there is a customer selected in the customer field to make the correct form selection happen.');
		}
	}
return true;
}
