 ...
 * 
 * @purpose: edit/deletion of PO/rotation
 * 
 ...
 *
 * [TODO] JM 21/5/2013 - is the create section here in the wrong js file  - should it be in createRotation.js
 */
...
var afterSubmit = function(type){
	...
	if(type == 'edit')
	{
		...
		var POExpectedDelivery = obj.getFieldValue('custbody_lhkreceiveby'); //Receipt Due Date
