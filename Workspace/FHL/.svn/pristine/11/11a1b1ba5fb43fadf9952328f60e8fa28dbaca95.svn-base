function createOnlineForm(request, response)
{
   if ( request.getMethod() == 'GET' )
   {
	...
	form.addField('custpage_comments','textarea', 'Comments');
        ...
        var contact = form.addSubList('contact','inlineeditor','Contact Editor', 'tab1');
        contact.addField('custpage_firstname','text', 'First Name');
        contact.addField('custpage_lastname','text', 'Last Name');
        contact.addField('custpage_title','text', 'Title');
        contact.addField('custpage_contactemail','email', 'Email');
        contact.addField('custpage_contactphone','phone', 'Phone');
