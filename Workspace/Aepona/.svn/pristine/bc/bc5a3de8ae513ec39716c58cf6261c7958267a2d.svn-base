...
function popup(category, categoryText, location, locationText, employee, iteration, baseCurrency, baseCurrencyText, subsidiary, currentExpenseMiles, date, claimAmount, lineedit)
{
	// Parameters to pass included in the URL for example: '&expensecategory='+category
	mywindow = window.open('/app/site/hosting/scriptlet.nl?script=68&deploy=1&custpage_expenseCategory='+ category + '&custpage_expensecategorytext=' + categoryText + '&custpage_expenselocation=' + location + '&expenseLocationText=' + locationText + '&custpage_iterate=' + iteration +'&custpage_currentEmployee=' + employee + '&custpage_basecurrency='+ baseCurrency + '&custpage_basecurrencytext=' + baseCurrencyText + '&custpage_subsidiary=' + subsidiary + '&custpage_currentExpenseMiles=' + currentExpenseMiles + '&custpage_date=' + date + '&custpage_claimamount=' + claimAmount + '&custpage_lineedit=' + lineedit, '_blank',"dependant=yes,height=600,width=750,scrollbars=0,titlebar=0,toolbar=no,menubar=0,resizable=no,location=no");	
} // function popup()
