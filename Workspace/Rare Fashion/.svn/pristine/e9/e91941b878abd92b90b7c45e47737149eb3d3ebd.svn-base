 ...
 * 				1.1.1 - 08/11/2012 - Added to Voicenet Solutions Project
 * 				1.1.2 - 12/12/2012 - added functionality for rare
 *
 * Author:		FHL
...
function runSavedSearchXMLWithCriteria(from, to, header, savedSearch, type, criteria)
{
	...
	try
	{
		...
		{
			tempFilters = loadSearch.getFilters();
			loadSearch.setFilterExpression(criteria);
	...
	{
		errorHandler("runSavedSearchXMLWithCriteria", e);
	}
