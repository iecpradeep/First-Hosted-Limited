...
if (type = 'edit')
	...
	if(reservationStatus == 2)
		...
		var item = nlapiGetCurrentLineItemValue('item','item');
						...
						if (item != 28)
							{
							if (isNotBlank(trnColReservation)) {updateExistingReservation(trnColReservation, customer, transactionNumber, trnColRotation, quantity, rate, lineNum, uom, units)}
							else  {createNewReservation(trnColReservation, trnColRotation, transactionNumber, customer, trnColRotation, quantity, rate, lineNum, uom, units)}
							}
