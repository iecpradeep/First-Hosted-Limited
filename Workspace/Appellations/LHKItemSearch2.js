...
{
	//var arrAux =  arrValues[i].split(";")
	//var filter=new nlobjSearchFilter("formulanumeric", 'notequalto',  1)
	///filter.setFormula("{custrecord_lotitem.custrecord_rotation_polineunits}");
	...
	if(myenpremiur!=1) mySearch=61// Make the search
	...
	response.write("addContent("+JSON.stringify(content)+")");
}
