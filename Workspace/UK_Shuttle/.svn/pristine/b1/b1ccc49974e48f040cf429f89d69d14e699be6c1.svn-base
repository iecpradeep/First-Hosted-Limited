function transportManager(request, response){
    var form = nlapiCreateForm('Transport Manager (v3.2a)');
    var rowLimit = 2000;
...
*/
	...
	*/
    ...
    form.addButton('custpage_tpnservicesummary', 'TPN by Service Summary ...', "window.open('../../../app/common/search/searchresults.nl?searchid=391','_blank')");
