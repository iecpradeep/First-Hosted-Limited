...
function labelAPCV2Printer(request, response, bulkprintcids, bulkprintfilename, labeldimensionid){
	...
	for (var soRec = 0; soRec < soRecords.length; soRec++) {
		...
		if (soRecordId) {
			...
			if (parseInt(labelDimension) >= 11) // New APC format
				LabelVersion = 3;
			...
			for (var i = (parseInt(lastLabelPrinted)+1); i <= parceltotal; i++) {
				...
				//--------- HTML output start	
				if (LabelVersion == 3) {
				    labelhtml += '<table ' + rotateHTML + ' align="right" style="table-layout:fixed;font-family: Sans-Serif; text-align:right; vertical-align:middle;margin: 0pt; padding: 4pt 0pt 0pt 0pt;" cellpadding="0">';
                    ...
                    labelhtml += '  <td id="row1col3" style="width: ' + parseInt(sizeFactor * 39) + 'mm; height=100%">';
                    ...
                    labelhtml += '        <tr><td align="right" class="depotPanel" style="width: ' + parseInt(sizeFactor * 18) + 'mm; height: ' + parseInt(sizeFactor * 11) + 'mm;"><b>' + parseInt(senddepot * 1) + '</b></td></tr>';
                    labelhtml += '       </table>';
                    ...
                    labelhtml += '        <tr><td align="right" class="depotPanel" style="width: ' + parseInt(sizeFactor * 18) + 'mm; height: ' + parseInt(sizeFactor * 11) + 'mm;">' + parseInt(reqdepot * 1) + '</td></tr>';
                    labelhtml += '       </table>';
                    labelhtml += '      </td>';
                    labelhtml += '     </tr>';
                    labelhtml += '     <tr>';
                    ...
                    labelhtml += '        <tr><td  align="center" class="depotPanel" style="width: ' + parseInt(sizeFactor * 18) + 'mm; height: ' + parseInt(sizeFactor * 11) + 'mm;">' + thisNo + '</td></tr>';
                    labelhtml += '       </table>';
                    labelhtml += '      </td><td width="' + parseInt(sizeFactor * 18) + 'mm">';
                    labelhtml += '       <table style="table-layout: fixed; vertical-align: top; margin: 0pt; padding: 0pt;" width="' + parseInt(sizeFactor * 18) + 'mm">';
                    ...
                    labelhtml += '        <tr><td align="right" class="depotPanel" style="width: ' + parseInt(sizeFactor * 18) + 'mm; height: ' + parseInt(sizeFactor * 11) + 'mm;">' + parceltotal + '</td></tr>';
                    labelhtml += '       </table>';
                    labelhtml += '      </td>';
                    labelhtml += '     </tr>';
                    labelhtml += '     <tr>';
                    ...
                    labelhtml += '        <tr><td align="right" class="depotPanel" style="height: ' + parseInt(sizeFactor * 10) + 'mm;">' + weight.toFixed(2) + '</td></tr>';
                    labelhtml += '       </table>';
                    labelhtml += '      </td>';
                    labelhtml += '     </tr>';
                    labelhtml += '    </table>'; 
                    labelhtml += '  </td>'; // Row 1 Col 3
				    labelhtml += '  <td id="row1col4" style="width: ' + parseInt(sizeFactor * 64) + 'mm; height: ' + parseInt(sizeFactor * 30) + 'mm;" align="center"><img src="' +  nlapiEscapeXML(logoURL) + '" width="' + parseInt(sizeFactor * 140) + '" height="' + parseInt(sizeFactor * 97) + '" /></td>'; // Row
                    ...
                    labelhtml += '        <tr><td colspan="2" align="right" font-stretch="condensed" style="width: ' + parseInt(sizeFactor * 133) + 'mm;" height="' + parseInt(sizeFactor * 14) + 'mm">';
                    ...
                    labelhtml += '           <tr><td class="consignordetails" align="center" style="width: ' + parseInt(sizeFactor * 60) + 'mm; height: ' + parseInt(sizeFactor * 38) + 'mm;text-align: center;"><img align="center" src="http://bcgen.com/img/52237-deltacomp-lin.aspx?Barcode=' + deldepotbarcode + '&amp;W=' + parseInt(sizeFactor * 400) + '&amp;BH=' + parseFloat(sizeFactor * 2.3).toFixed(2) + '&amp;TM=0.0&amp;LM=0.15&amp;CS=0&amp;ST=F" /></td></tr>';                    
                    labelhtml += '          </table>';
                    ...
                    labelhtml += '           <tr><td class="consignordetails" colspan="2" align="left" style="width: ' + parseInt(sizeFactor * 73) + 'mm; height: ' + parseInt(sizeFactor * 11) + 'mm;text-align: left;">' + v2ContactRef + '</td></tr></table></td></tr>';                    
				...
				labelhtml += '  <table>';
				labelhtml += '   <tr>';
				labelhtml += '    <td style="width:20mm;"><span class="title' + offStyle + '">Consignor</span></td><td class="consigneeline" style="width:' + parseInt(sizeFactor * 47) + 'mm;height:' + parseInt(sizeFactor * 5) + 'mm;"><table><tr><td style="width:' + parseInt(sizeFactor * 35) + 'mm;" class="consigneeline" align="left"><b>' + companyname + '</b></td></tr><tr><td style="width:' + parseInt(sizeFactor * 35) + 'mm;height:' + parseInt(sizeFactor * 5) + 'mm;" class="consigneeline" align="right"><b>' + companyref + '</b></td></tr></table></td>';
				labelhtml += '   </tr>';
				labelhtml += '   <tr>';
...
function isCustomerCenter(){
    ...
    if (theRole == 14 || theRole == 1001 || theRole == 1015 || theRole == 1005 || theRole == 1006 || theRole == 1007 || theRole == 1008) 
        isCenter = true;
    return isCenter;
}
