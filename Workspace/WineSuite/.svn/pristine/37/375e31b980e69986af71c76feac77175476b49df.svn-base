...
function createNewReservation(salesOrderNumber, customer, numLines)
{
		...
		// Gets the internal ID of the suitelet from the parameters.
		var context = nlapiGetContext();
		var rso_suitelet_internal_id = context.getSetting('SCRIPT','custscript_rso_suitelet_internal_id');
		
		
		var url_servlet = nlapiSetRedirectURL('SUITELET',rso_suitelet_internal_id, 1, null, params);
		return true;
}
