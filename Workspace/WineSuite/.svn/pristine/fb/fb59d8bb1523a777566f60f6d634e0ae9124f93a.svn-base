...
var inventoryTransfer = function(){
	var rotationId = nlapiGetRecordId();
	var rotationType = nlapiGetRecordType();
	var item = nlapiLookupField(rotationType, rotationId, 'custrecord_lotitem');
	var redirectUrl = nlapiResolveURL('RECORD', 'customrecord_lhk_rit', null);
	var newURL = redirectUrl + '&item=' + item + '&rotation=' + rotationId;
	window.location = newURL;
};

var inventoryAdjustment = function(){
	var rotationId = nlapiGetRecordId();
	var rotationType = nlapiGetRecordType();
	var item = nlapiLookupField(rotationType, rotationId, 'custrecord_lotitem');
	var redirectUrl = nlapiResolveURL('RECORD', 'customrecord_lhk_ria', null);
	var newURL = redirectUrl + '&item=' + item + '&rotation=' + rotationId;
	window.location = newURL;
};
...
var updateRotationRecord = function(){
