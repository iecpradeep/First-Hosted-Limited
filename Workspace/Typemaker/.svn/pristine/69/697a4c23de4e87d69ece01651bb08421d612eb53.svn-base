 ...
 * 1.00       1 Jul 2013     Peter Lewis, First Hosted Ltd
 *
 */
...
function salesOrderClientSave()
{
	...
	{
		errHandler('salesOrderClientSave',e);
		saveRecord = false;
	}
	return saveRecord;
}
 ...
 * 
 * On Edit on the Sales Order, check for the EC Sale Item
...
function pageInitialise()
{
	try
	{
		//on edit mode of Sales Order, check line item count.
		...
		else
		{
			...
			//This is a new Sales Order, and as such there are no line items on it.
		}
